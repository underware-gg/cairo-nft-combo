...
fn test_initializer() {
    ...
    assert!(sys.character.supports_interface(introspection::ISRC5_ID), "should support ISRC5_ID");
    assert!(sys.character.supports_interface(erc721::IERC721_ID), "should support IERC721_ID");
    assert!(sys.character.supports_interface(erc721::IERC721_METADATA_ID), "should support METADATA");
